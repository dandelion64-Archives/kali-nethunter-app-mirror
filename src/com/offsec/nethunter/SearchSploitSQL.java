...
class SearchSploitSQL extends SQLiteOpenHelper {
    ...
    Boolean doDbFeed() {
        ...
        String _cmd1 = "su -c /data/data/com.offsec.nethunter/files/scripts/bootkali custom_cmd '/usr/bin/python3 /sdcard/nh_files/modules/csv2sqlite.py /usr/share/exploitdb/files_exploits.csv /root/SearchSploit " + SearchSploit.TABLE + "'";
